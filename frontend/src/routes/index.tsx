  ...
  head: () => ({
    meta: [
      { title: "Mediqueue - Smart Hospital Appointment & Queue Management" },
      {
        name: "description",
        content:
          "Book appointments, join the queue from anywhere, and track your wait time in real time at St. Helena Medical Center.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Book appointments, join the queue from anywhere, and track your wait time in real time.",
      },
    ],
  }),
  component: Landing,
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-30 backdrop-blur bg-background/80 border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-muted-foreground">
            ...
            <a href="#queue" className="hover:text-foreground">
              Live queue
            </a>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/login"
              className="hidden sm:inline-flex h-10 items-center px-4 rounded-lg text-sm font-medium text-foreground hover:bg-muted"
            >
              Sign in
            </Link>
            <Link
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 pt-14 pb-20 grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs text-muted-foreground">
                <span className="size-1.5 rounded-full bg-success" /> Live at St. Helena Medical
                Center
              </div>
              ...
              <p className="mt-5 text-lg text-muted-foreground max-w-xl">
                Book appointments, join the queue from home, and watch your wait time shrink in real
                time so you arrive exactly when the doctor is ready.
              </p>
        ...
        <section id="how" className="py-20 border-t border-border bg-surface">
          <div className="max-w-7xl mx-auto px-6">
            <SectionHeader
              ...
              title="Three calm steps, from booking to seen by your doctor."
            />
              ...
              {[
                {
                  ...
                  d: "Search by symptom, specialty or doctor. Pick a slot that fits your day.",
                  i: Calendar,
                },
                {
                  n: "02",
                  t: "Join the queue from home",
                  d: "Check in remotely. We'll let you know exactly when to leave.",
                  i: Activity,
                },
                {
                  n: "03",
                  t: "Arrive when it's your turn",
                  d: "No more crowded waiting rooms. Walk in, sit down, get seen.",
                  i: CheckCircle2,
                },
              ].map((s) => (
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeader
                ...
                title="A calmer waiting experience, designed with patients and clinicians."
                align="left"
              />
              <ul className="mt-8 space-y-4">
                {[
                  {
                    i: Heart,
                    t: "Less anxiety, more clarity",
                    d: "Always know where you are in the queue and how long until you're called.",
                  },
                  {
                    i: Clock,
                    t: "Wait at home, not the lobby",
                    d: "Get a 15‑minute heads‑up before your turn so you can leave on time.",
                  },
                  {
                    i: ShieldCheck,
                    t: "Private and secure",
                    d: "Your medical data is encrypted and stays inside the hospital network.",
                  },
                ].map((b) => (
                  <li key={b.t} className="flex gap-4">
                    <div className="size-10 shrink-0 rounded-xl bg-secondary text-secondary-foreground grid place-items-center">
              ...
              <Link
                to="/patient"
                className="mt-8 inline-flex items-center gap-2 text-primary font-medium"
              >
            ...
            >
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                {["A-039", "A-040", "A-041"].map((n, idx) => (
                  <div
                    key={n}
                    className={`rounded-xl border p-4 text-center ${idx === 1 ? "border-primary bg-primary/5" : "border-border bg-surface"}`}
                  >
                    <div className="text-[10px] uppercase tracking-wider text-muted-foreground">
                      {idx === 0 ? "Done" : idx === 1 ? "In room" : "Next"}
                    </div>
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="size-9 rounded-lg bg-card border border-border grid place-items-center text-sm font-semibold">
                        {r.n}
                      </div>
                      <div className="text-sm text-foreground">{r.w}</div>
                    </div>
                    <div className="text-xs text-muted-foreground inline-flex items-center gap-1">
                      <Clock className="size-3" /> {r.t}
                    </div>
                  </div>
                ))}
              </div>
        ...
        <section className="py-20 border-t border-border bg-surface">
          <div className="max-w-7xl mx-auto px-6">
            <SectionHeader
              eyebrow="Patients & staff"
              title="Trusted by clinicians and the people they care for."
            />
            <div className="mt-12 grid md:grid-cols-3 gap-6">
              {[
                {
                  q: "I used to lose half a day waiting. Now I show up 10 minutes before my turn and walk straight in.",
                  a: "Hannah L.",
                  r: "Patient · Pediatrics",
                },
                {
                  q: "It cleared the corridor congestion. My team focuses on care, not crowd control.",
                  a: "Dr. Yusuf Aydın",
                  r: "Head of Internal Medicine",
                },
                {
                  q: "Reception finally feels calm. Patients arrive informed and relaxed.",
                  a: "Priya R.",
                  r: "Front desk lead",
                },
              ].map((t) => (
        ...
        <section id="trust" className="py-20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              Join thousands of patients already using Mediqueue at St. Helena Medical Center.
            </p>
            <div className="mt-8 flex flex-wrap gap-3 justify-center">
              <Link
                to="/book"
                className="inline-flex items-center gap-2 h-12 px-5 rounded-xl bg-primary text-primary-foreground font-medium"
              >
                Book appointment
              </Link>
              <Link
                to="/queue"
                className="inline-flex items-center gap-2 h-12 px-5 rounded-xl border border-border bg-card text-foreground font-medium"
              >
                View live queue
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-4 gap-8 text-sm">
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              St. Helena Medical Center's official patient platform.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>
                <Link to="/patient">My dashboard</Link>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="inline-flex items-center gap-2">
                <MapPin className="size-3.5" /> 1200 Lakeside Ave, City
              </li>
              <li className="inline-flex items-center gap-2">
                <Phone className="size-3.5" /> +1 (555) 010‑2200
              </li>
            </ul>
          </div>
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              <span className="font-semibold text-foreground">911</span> or come directly to the ER
              (open 24/7).
            </p>
          </div>
        </div>
        <div className="border-t border-border py-5 text-center text-xs text-muted-foreground">
          © 2026 St. Helena Medical Center · HIPAA compliant
        </div>
      </footer>
    </div>
  );
...
function SectionHeader({
  ...
  return (
    <div className={align === "center" ? "text-center max-w-2xl mx-auto" : "max-w-2xl"}>
      ...
      <h2 className="mt-3 text-3xl md:text-[40px] leading-tight font-semibold tracking-tight text-foreground">
        {title}
      </h2>
    </div>
  );
